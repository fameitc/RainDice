...
public class DotsView extends View {
    ...
    public void drawCompletedDotsGreen(Canvas canvas,int dots){
        ...
        int x = centerwidth;
        if(dots == 1) {
            canvas.drawCircle(x,height - (float) (y + 0.5*cw),cw/3,white);
            canvas.drawCircle(x,height - (float) (y + 0.5*cw),cw/3,strokePaint);
            return;
        }
        if(dots--<=0)return;
        canvas.drawCircle((float) (x + cw*0.5),height - (float) (y + 0.5*cw), cw/3,white);
        canvas.drawCircle((float) (x + cw*0.5),height - (float) (y + 0.5*cw), cw/3,strokePaint);
        if(dots--<=0)return;
        canvas.drawCircle((float) (x - cw*0.5),height - (float) (y + 0.5*cw), cw/3,white);
        canvas.drawCircle((float) (x - cw*0.5),height - (float) (y + 0.5*cw), cw/3,strokePaint);
        if(dots--<=0)return;
        canvas.drawCircle(x,height - (float) (y + 1.2*cw),cw/3,white);
        canvas.drawCircle(x,height - (float) (y + 1.2*cw),cw/3,strokePaint);
    }
