package com.asli.rummy._RedBlack;
...
//    private final String HIGH_CARD = "HIGH";
    ...
    private final int minGameAmt = 50;
    private final int maxGameAmt = 500;
    private int GameAmount = 50;
    private final int StepGameAmount = 50;
    private final int _30second = 30000;
    private final int GameTimer = 30000;
    ...
    private void Initialization() {
        ...
        sound = new Sound();
        initSoundPool();
        rl_AnimationView = findViewById(R.id.sticker_animation_layout);
...
//        float destY = toLoc[1];
        ...
        int centreX = (boardWidth / 2) - (chips_width / 2);
        int centreY = (boardHeight / 2) - (chips_width / 2);
        try {
            ...
            Log.e("TAG", "DummyChipsAnimations: "+e.toString() );
        }
