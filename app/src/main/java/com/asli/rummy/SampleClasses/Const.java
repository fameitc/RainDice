package com.asli.rummy.SampleClasses;
...
public class Const {
    ...
    // Enter your Base URL
//    public static final String MAIN = "http://167.71.233.36/letscard/";
    public static final String MAIN = "http://64.227.150.78/letscard/";

    public static final String IMGAE_PATH = MAIN + "data/post/";
    public static final String REDEEM_IMGAE_PATH = MAIN + "data/Redeem/";

    public static final String PRIVACY_POLICY = MAIN + "privacy-policy";
    public static final String TERMS = MAIN + "terms-conditions";
...
//    public static final String BSE_URL2 = MAIN2+"api/";
    ...
    public static String Transfer = BSE_URL + "redeem/Transfer";
    ...
    public static final String GET_PHONE_PE_TOKEN = BSE_URL+"PhonePe/generate_phonepe_token";

    public static final String GET_PHONE_PAYMENT_STATUS = BSE_URL+"PhonePe/phonepe_payment_status";
